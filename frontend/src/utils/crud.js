...
const submitRecord = (form, modal, modalFooter, btnPostModal, section = null) => {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    if (section == "config") {
      ...
      if (mode === 'update') {
        url = `https://demos-pelu-lnw1.vercel.app/cutservices/${id}`;
        // url = `http://localhost:3001/cutservices/${id}`;
        method = 'PUT';
      } else {
        url = `https://demos-pelu-lnw1.vercel.app/cutservices`;
    ...
    if (section == "manageEmployees") {
      ...
      if (mode === 'update') {
        url = `https://demos-pelu-lnw1.vercel.app/users/${id}`;
        // url = `http://localhost:3001/users/${id}`;
        method = 'PUT';
      } else {
        url = `https://demos-pelu-lnw1.vercel.app/register`;
    ...
    if (section == "voucher") {
      ...
      if (mode === 'update') {
        url = `https://demos-pelu-lnw1.vercel.app/vouchers/${id}`;
        // url = `http://localhost:3001/vouchers/${id}`;
        method = 'PUT';
      } else {
        url = `https://demos-pelu-lnw1.vercel.app/vouchers`;
    ...
    if (section == "manageClients") {
      ...
      if (mode === 'update') {
        url = `https://demos-pelu-lnw1.vercel.app/clients/${id}`;
        // url = `http://localhost:3001/clients/${id}`;
        method = 'PUT';
      } else {
        url = `https://demos-pelu-lnw1.vercel.app/clients`;
